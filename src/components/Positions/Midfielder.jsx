...
import './Attacker.css'
import { midfielderData } from '../../data/midfielderData'
...
export const Midfielder = () => {
    ...
    const tLength = midfielderData.length;
  return (
        ...
        <div className="intro-container">
         ...
         <div className="attacker">    
            <div className="left-t">
                    ...
                    >{midfielderData[selected].review}
                    </motion.span>
                    <span>
                        <span style ={{color: 'var(--orange)'}}>
                            {midfielderData[selected].name}
                        </span>{" "}
                        - {midfielderData[selected].status}
                    </span>
                </div>
                <div className="right-t">
                    ...
                    exit={{opacity:0, x : -100}}
                    transition = {{ ...transition, duration:2}}
                    src={midfielderData[selected].image} alt="" />
